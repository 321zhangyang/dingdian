...
class MineReadHistoryListItem extends StatelessWidget {
 final BookDetailInfoModel? model;

  const MineReadHistoryListItem({Key? key, this.model}) : super(key: key);
  @override
