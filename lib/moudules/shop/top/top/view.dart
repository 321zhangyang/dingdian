              ...
              Row(
                ...
                children: [
                  Container(
                        ...
                        height: ScreenUtil.getInstance().screenHeight - 50 - 50 - ScreenUtil.getInstance().appBarHeight -ScreenUtil.getInstance().bottomBarHeight - ScreenUtil.getInstance().statusBarHeight - 47 ,
